    ...
    return (
        <div className="bg-[#ACC8E5]">
            <div className="px-4 pt-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
                <div className="flex flex-col justify-between row-gap-10 mb-8 lg:flex-row">
                    <div className="flex justify-evenly gap-5 lg:col-span-4 md:grid-cols-4 flex-1">
                        <div>
                            <Link
                                to="/"
                                aria-label="Company"
                    ...
                    <div className="md:max-w-md lg:col-span-2">
                        <span className="text-base font-medium tracking-wide text-[#000]">
                ...
                <div className="flex flex-col justify-between pt-5 pb-10 border-t border-gray-800 sm:flex-row">
                    <p className="text-sm text-[#000]">
                        © Copyright 2024 Study Group All rights reserved.
                    </p>
