            ...
            <div className="px-4 py-8 shadow-lg max-w-[350px] font-sans rounded-xl space-y-6 mx-auto">
                ...
                <div className="text-center w-[85%] mx-auto font-semibold space-y-2">
                    ...
                    <p className="text-gray-400 text-xs md:text-sm font-semibold">
                        this is the description section so i have a some pera
                    </p>
                </div>
                <div className="flex items-center justify-center flex-wrap gap-6 text-sm md:text-base">
                    <button className="px-8 py-2 w-full rounded-lg bg-[#49B2FF] hover:bg-sky-600 duration-300 hover:scale-105 text-white font-semibold font-sans">Details</button>
                </div>
            </div>
        </>
    );
